...
function local_aiskillnavigator_mm_clean_text($value): string {
    ...
    $replacements = [
        ...
        "ÃƒÆ’Ã‚ " => "Ã ", "ÃƒÆ’Ã‚Â¨" => "Ã¨", "ÃƒÆ’Ã‚Â©" => "Ã©", "ÃƒÆ’Ã‚Â¬" => "Ã¬", "ÃƒÆ’Ã‚Â²" => "Ã²", "ÃƒÆ’Ã‚Â¹" => "Ã¹",
        "ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚ " => "Ã ", "ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨" => "Ã¨", "ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©" => "Ã©", "ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¬" => "Ã¬", "ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â²" => "Ã²", "ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¹" => "Ã¹",
        "Ã‚Â·" => "Â·", "Ãƒâ€šÃ‚Â·" => "Â·", "Ã‚Â°" => "Â°", "Ãƒâ€šÃ‚Â°" => "Â°",
        "’" => "'", "‘" => "'", "“" => '"', "â€\u009d" => '"', "–" => "-", "—" => "-",
        "’" => "'", "“" => '"', "â€\u009d" => '"', "–" => "-",
    ];
    $text = strtr($text, $replacements);

    $text = preg_replace('/(?:Ã|Â|Â|â€|’|“|–|—|‚Â|ƒÆ)[\\s\\S]*/u', '', $text);
