...
if (empty($assessments)) {
    ...
    foreach ($assessments as $assessment) {
        ...
        echo html_writer::div(
            html_writer::tag('strong', (string) $count) . html_writer::tag('br') . 'Attempts',
            'col-md-3 alert alert-secondary'
        );

        echo html_writer::div(
            html_writer::tag('strong', (string) $avg . '%') . html_writer::tag('br') . 'Average score',
            'col-md-3 alert alert-info'
        );

        echo html_writer::div(
            html_writer::tag('strong', (string) $high) . html_writer::tag('br') . (
        ...
        echo html_writer::div(
            html_writer::tag('strong', (string) $low) . html_writer::tag('br') . 'Students below 50%',
